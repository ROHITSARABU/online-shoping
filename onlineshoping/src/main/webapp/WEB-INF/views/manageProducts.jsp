	...
	<div class="modal-dialog" role="document">
		...
		<!-- modal Header -->
			...
			<div class="modal-body">
				<!-- Category form -->
				<sf:form id="categoryFrom" modelAttribute="category" action="${contextRoot}/manage/category" 
					...
					<label for="category_description" class="control-label col-md-4">Category Description</label>
						<div class="col-md-8">
							<sf:textarea cols="" rows="5" id="category_description" path="description" class="form-control"/>
						</div>
